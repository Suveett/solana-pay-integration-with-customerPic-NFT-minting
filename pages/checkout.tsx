//This is the User Wallet side..
import {/* findTransactionSignature, validateTransactionSignature, FindTransactionSignatureError, */encodeURL, findReference, FindReferenceError} from "@solana/pay";
...
export default function Checkout() {
  ...
  async function getTransaction() {
    ...
    //const response = await fetch(`/api/makeTransaction?${encodeURIComponent(searchParams.toString())}`, {
